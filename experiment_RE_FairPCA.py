from FairnessAwarePCA.methods import FairnessAwarePCA_MW, preprocess_data
...
for d in range(1, 21):
    ...
    algorithm = FairnessAwarePCA_MW(sensitive_col, d, 1, 10)
    ...
    for train_index, test_index in skf.split(X, sensitive_col):
        ...
        X_test_transformed = X_test_transformed @ algorithm.components_.T
        ...
        X_train_transformed = X_train_transformed @ algorithm.components_.T
        ...
        for idx, group_data in enumerate(groups):
            ...
            group_data_transformed = group_data_transformed @ algorithm.components_.T
...
f = open("experiment_RE_CV_FairPCA.pickle", "wb")
